...
public class CounterStepIncreaseTest {
    ...
    public void mainActivityTest2() {
        ...
        onView(withIndex(withId(R.id.iv_counter_edit), 0)).perform(click());
        ...
        onView(withIndex(withId(R.id.iv_increase), 0)).perform(click());
        ...
        ViewInteraction textView2 = onView(
                allOf(withIndex(withId(R.id.tv_counter_value) , 0),
                        isDisplayed()));
